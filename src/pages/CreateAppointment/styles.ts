...
export const ProvidersListContainer = styled.View`
  height: 112px;
`;
export const ProviderContainer = styled(RectButton)<IProvidersContainerProps>`
...
export const OpenDatePikerButon = styled(RectButton)`
  height: 46px;
  background: #ff9000;
  border-radius: 10px;
  align-items: center;
...
export const OpenDatePikerButonText = styled.Text`
  font-family: 'RobotoSlab-Medium';
  font-size: 16px;
  color: #232129;
`;
